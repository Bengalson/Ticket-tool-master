...
client.on('messageReactionAdd',async (messageReaction,user)=>{
    ...
    function SpamTicket(auID,chID){
        return new Discord.MessageEmbed()
            ...
            .setTimestamp()
            .setFooter('Bengalson#0001  - Type $help 🎵','https://cdn.discordapp.com/avatars/774628881910202378/548e0caa288842504514596856039e9c.png?size=256');
    }
